...
while count <= 30:
    ...
    human_input = input("Enter gesture R/P/S: ")
#     human_input = h_temp[count-1]
#     print("Enter gesture R/P/S:",human_input)
    human_choices_arr.append(human_input)
    
    com_pattern_select = ""  # Re-instaniate com_pattern_select
...
#             print("PATTERNIZED: TRIPLETS")
            com_select = play_pattern(pattern_analyzer(human_choice_arr,computer_choice_arr)[1],0)
        
        elif predicted_pattern == "pairs":
#             print("PATTERNIZED: PAIRS")
            com_select = play_pattern(pattern_analyzer(human_choice_arr,computer_choice_arr)[1],0)

        elif predicted_pattern == "copycat":
#             print("PATTERNIZED: COPYCAT")
            com_select = play_copycat(computer_choice_arr)

        elif predicted_pattern == "rat":
 #           print("PATTERNIZED: RAT")
            com_select = play_rat(computer_choice_arr)

        
        game_patterned_outcome = pattern_player_outcome(human_input,com_select)

        if game_patterned_outcome[0] == "C":
            com_wins += 1
            print("Computer choice:", game_patterned_outcome[2])
            print("Computer wins")

        elif game_patterned_outcome[0] == "H":
            hum_wins += 1
            print("Computer choice:", game_patterned_outcome[2])
            print("Human wins")
        ...
        human_choice_arr.append(game_patterned_outcome[1])    
        computer_choice_arr.append(game_patterned_outcome[2])
        cheating += 1
    
    # If no pattern detected, and less than 10 rounds of play, play a basic manner
    elif count < 9 and pattern_analyzer(human_choice_arr,computer_choice_arr) == False:
        # Basic game play will be chosen ==> E.g: "D", human_input, com_select, fut_com_select
        
#         print("BASIC GAME PLAY")
        game_outcome_basic = play_basic(human_input, com_select)

        if game_outcome_basic[0] == "C":
            com_wins += 1
            print("Computer choice:", game_outcome_basic[2])
            print("Computer wins")

        elif game_outcome_basic[0] == "H":
            hum_wins += 1
            print("Computer choice:", game_outcome_basic[2])
            print("Human wins")
        ...
        human_choice_arr.append(game_outcome_basic[1])
        computer_choice_arr.append(game_outcome_basic[2])
    ...
    # If number of rounds played >= 10
        ...
        # Remove cheats
#         human_choice_arr = remove_cheats(human_choice_arr, cheating)
#         print("NUMBER OF CHEATS REMOVED",cheating)
#         print(len(human_choice_arr))
#         cheating = 0    # Reset cheat meter to 0

        com_prob_select = ""
        if get_probability(human_choice_arr,computer_choice_arr) != "":
#             print("TRUE PROBABLISTIC LEARNER")
...
#             print("HIGHEST PROBABLISTIC LEARNER")
        ...
        game_outcome_advanced =  pattern_player_outcome(human_input,com_select)

        # Give outcome ==> E.g: ("H", human_input, com_select)
        if game_outcome_advanced[0] == "C":
            com_wins += 1
            print("Computer choice:", game_outcome_advanced[2])
            print("Computer wins")

        elif game_outcome_advanced[0] == "H":
            hum_wins += 1
            print("Computer choice:", game_outcome_advanced[2])
            print("Human wins")
        ...
        human_choice_arr.append(game_outcome_advanced[1])    
        computer_choice_arr.append(game_outcome_advanced[2])

    # Calculate difference in probablity scores
...
total_games = count - 1
draw = total_games - com_wins - hum_wins
perc_com_wins = (com_wins /(hum_wins+com_wins)) * 100
print()
print("===================== FINAL SCORES ============================")
print("Number of times computer wins:", com_wins)
print("Number of times human wins", hum_wins)
print("Number of times draw", draw)
print()

print("===================== GAME STATISTICS ============================")
print("Percentage of {0} winning {1:.2f}%".format("Computer",perc_com_wins))
print()
com_outcome = get_com_prob(computer_choice_arr)
hum_outcome = get_prob(human_choices_arr)
print("Human's choices:",hum_outcome)
print("Computer's choices:",com_outcome)